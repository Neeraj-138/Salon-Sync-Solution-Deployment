...
function NoOfClients() {
    ...
    useEffect(()=>{
        axios.get('salonsyncbackend.vercel.app/api/branch/branches/therapist')
        .then(res=>{
            if(!res.data.Status){
    ...
    useEffect(()=>{
        axios.get('salonsyncbackend.vercel.app/api/branch/branches/details')
        .then(res=>{
            if(!res.data.Status){
    ...
    useEffect(()=>{
        axios.get('salonsyncbackend.vercel.app/api/branch/branches/appointment')
        .then(res=>{
            if(!res.data.Status){
                console.log(res.data.message)
            }else{
