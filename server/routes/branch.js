...
router.delete('/deletebranch/:bId',isAuthenticate,isAdmin,deleteBranch);
...
router.post('/branch',isAuthenticate,isAdmin,addBranch);
router.put('/updateBranch/:id',isAuthenticate,isAdmin,branchUpdate);
...
router.get('/branches/totalRevanue',isAuthenticate,isAdmin,getTotalRevanue);
